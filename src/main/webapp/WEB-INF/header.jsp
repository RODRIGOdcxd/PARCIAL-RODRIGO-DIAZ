...
<header>
	...
	<nav class="menu">
		...
		<ul class="menu-principal">
    		<li class="menu-item"><a href="PeliculaSVL?id=cartelera">Cartelera</a></li>
       		<li class="menu-item"><a href="PeliculaSVL?id=estrenos">Próximos estrenos</a></li>
       		<li class="menu-item"><a href="http://www.cinestar.com.pe/starcard">Star Card</a></li>
        	<li class="menu-item"><a href="svlCines">Nuestros Cines</a></li>
